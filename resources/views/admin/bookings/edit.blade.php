                ...
                <form method="POST" action="{{ route('admin.bookings.update', $booking) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="notes" 
                                  ...
                                  rows="3" 
                                  placeholder="Optional notes from student...">{{ old('notes') ?? $booking->notes }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="admin_notes" 
                                  ...
                                  rows="3" 
                                  placeholder="Optional admin notes about this booking...">{{ old('admin_notes') ?? $booking->admin_notes }}</textarea>
                        @error('admin_notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
