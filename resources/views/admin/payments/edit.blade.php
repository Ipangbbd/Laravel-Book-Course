        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info">
                    ...
                    <p class="mb-1"><strong>Student:</strong> {{ $payment->booking->user->name }} ({{ $payment->booking->user->email }})</p>
                ...
                <form method="POST" action="{{ route('admin.payments.update', $payment) }}">
                    ...
                    <div class="form-group" id="rejection_reason_group" style="display: none;">
                        ...
                        <textarea id="rejection_reason" name="rejection_reason" 
                                  ...
                                  rows="3" placeholder="Please provide a reason for rejecting this payment...">{{ old('rejection_reason', $payment->rejection_reason) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="admin_notes" name="admin_notes" 
                                  ...
                                  rows="3" placeholder="Optional administrative notes...">{{ old('admin_notes', $payment->admin_notes) }}</textarea>
                        @error('admin_notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
