            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <h4 class="text-success">Rp.{{ number_format($payment->amount, 2) }}</h4>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Schedule:</strong>
                        {{ $payment->booking->schedule->start_datetime ? $payment->booking->schedule->start_datetime->format('M d, Y H:i') : 'N/A' }}
                    </p>
