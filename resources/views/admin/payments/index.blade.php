                                ...
                                <tbody>
                                    @foreach($payments as $payment)
                                        <tr>
                                            ...
                                            <td>
                                                <strong>Rp.{{ number_format($payment->amount, 2) }}</strong>
                                            </td>
                                            <td>
                    ...
                    <div class="modal-content">
                        <form method="POST" action="{{ route('admin.payments.reject', $payment) }}">
                            ...
                            <div class="modal-body">
                                <p><strong>Payment:</strong> Rp.{{ number_format($payment->amount, 2) }}</p>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form method="POST" action="{{ route('admin.payments.destroy', $payment) }}">
                            ...
                            <div class="modal-body">
                                <p><i class="fa fa-exclamation-triangle text-warning"></i> <strong>Are you sure you want to delete
                                        this payment?</strong></p>
                                <p><strong>Payment Amount:</strong> Rp.{{ number_format($payment->amount, 2) }}</p>
                                <p><strong>Student:</strong> {{ $payment->booking->user->name }}</p>
                                <p><strong>Booking:</strong> {{ $payment->booking->booking_code }}</p>
                                <div class="alert alert-warning">
                                    <small><i class="fa fa-info-circle"></i> This action cannot be undone. The associated booking
                                        status may be reset to pending.</small>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
