                ...
                <form method="POST" action="{{ route('admin.payments.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        @if($bookingsWithoutPayments->isEmpty())
                            <small class="text-muted">No bookings available for payment. All bookings either have payments or are cancelled.</small>
                        @endif
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Verified payments will automatically approve the booking.</small>
                            </div>
                        </div>
                    </div>
