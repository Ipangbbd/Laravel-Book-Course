                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p><i class="fa fa-clock-o"></i>
                                            {{ $category->updated_at ? $category->updated_at->format('M d, Y H:i') : 'N/A' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="{{ route('admin.courses.create') }}?category={{ $category->id }}"
                                ...
                                <div class="row text-center">
                                    ...
                                    <div class="col-6">
                                        <h4 class="text-success">
                                            {{ $category->courses->where('status', 'active')->count() }}</h4>
