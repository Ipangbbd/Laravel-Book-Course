                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            ...
                            <small
                                class="text-muted">({{ $schedule->start_datetime ? $schedule->start_datetime->diffForHumans() : 'N/A' }})</small>
                        </div>
                    </div>
                        ...
                        <div class="col-md-9">
                            ...
                            @if($schedule->start_datetime && $schedule->end_datetime)
                                <small class="text-muted">(Duration:
                                    {{ $schedule->start_datetime->diff($schedule->end_datetime)->format('%H:%I hours') }})</small>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <span
                                class="badge badge-{{ $schedule->booked_slots > 0 ? 'warning' : 'secondary' }}">{{ $schedule->booked_slots }}</span>
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body text-center">
                    ...
                    <small class="text-muted">
                        {{ $schedule->available_slots > 0 ? round(($schedule->booked_slots / $schedule->available_slots) * 100) : 0 }}%
                        Full
                    </small>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p><strong>Price:</strong> Rp.{{ number_format($schedule->course->price, 2) }}</p>
