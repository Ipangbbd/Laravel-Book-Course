...
@section('title', 'Add New Schedule - Admin')
                    ...
                    <form method="POST" action="{{ route('admin.schedules.store') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="available_slots" id="available_slots"
                                        ...
                                        value="{{ old('available_slots') }}" min="1" max="100" required>
                                    @error('available_slots')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Number of students that can book this schedule.</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="notes" id="notes" class="form-control @error('notes') is-invalid @enderror"
                                rows="4" placeholder="Optional notes about this schedule...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
