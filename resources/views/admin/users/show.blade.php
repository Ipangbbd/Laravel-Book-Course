                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <div class="row text-center">
                                    ...
                                    <div class="col-md-4">
                                        <h4 class="text-warning">{{ $user->bookings->where('status', 'active')->count() }}</h4>
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li class="mb-2">
                                    ...
                                    @if($user->email_verified_at)
                                        ...
                                        <small class="text-muted">{{ $user->email_verified_at ? $user->email_verified_at->format('M d, Y') : 'N/A' }}</small>
                                    @else
